...
// Create a structure that holds information to be displayed in our HTML file
type Welcome struct {
	Name string
	Time string
}
...
//once the server begins. Our html code would therfore be <link rel="stylesheet" href="/static/stylesheet/...">
// It is important to note the final url can be whatever we like, so long as we are consistent.


	//This method takes in the URL path "/" and a function that takes in a response writter, and a http request.
